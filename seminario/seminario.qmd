...
- Comparação de taxas de desemprego estimadas pelo modelo misto logit multinomial com aquelas obtidas pelo modelo logit misto univariado para desempregados
...
![Valores empíricos do erro quadrático médio segundo os modelos multinomial e binomial](img/mse.001.jpeg)
